...
parser = argparse.ArgumentParser(description="Exchange prediction")
parser.add_argument('--seed', type=int, default=555, help='The random seed')
parser.add_argument('--depth', type=int, default=30, help='The length of time series')
...
if __name__ == '__main__':
    ...
    data_path = args.data_dir or os.path.join(os.path.dirname(__file__), 'DATA', 'Exchange')
    ...
    for exp_id in range(args.num_exp):
        for model_name in model_list:
            ...
            exchange_training(model, model_name, train_loader, val_loader, test_loader, args, device, exp_id)
